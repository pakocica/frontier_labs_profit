...
_MC_HELP = (
    ...
    "space; unticked, every draw pins it at the spot value. Default ranges are the tight "
    "documented bands; single-source dimensions start unticked until you tick and widen "
